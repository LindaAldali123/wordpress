...
<div class="container home-page">
    <div class="categrory-informaion text-center my-3 bg-info text-white p-3">
        <div class="row align-items-center">
            <div class="col-md-4">
                <h1 class="category-title"><?php single_cat_title(); ?></h1>
            </div><!-- col-md-4 -->
            <div class="col-md-4">
                <div class="lead align-self-center pt-3"><?php echo category_description(); ?></div>
        ...
        <h1 class="text-center">I'm inside category-html.php</h1>
    </div><!-- categrory-informaion -->
    <div class="row">
